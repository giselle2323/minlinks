  ...
  return (
    <div className="navbar mb-2 text-neutral-content">
      <div className="flex-1 px-2 mx-2">
        <span className="text-lg font-bold logo">
          <svg
            width="169"
            height="53"
            viewBox="0 0 169 53"
          ...
          <a className=" btn btn-ghost btn-sm rounded-btn">
            ...
            <div className="inline-block w-10">
              ...
              <span
                ...
                className="border rounded-full border-accent flex items-center cursor-pointer w-10 bg-green transition-all duration-300 ease-in-out pl-0 pl-4"
              >
                {" "}
                <span className="rounded-full w-3 h-3 m-1 bg-accent">
                  {" "}
                </span>{" "}
              </span>{" "}
            </div>{" "}
